...
# Copier les fichiers web et les classes compilées
...
# Vérification
RUN echo "=== Classes servlet ===" && ls -la /usr/local/tomcat/webapps/ROOT/WEB-INF/classes/com/rdv/servlet/ 2>/dev/null || echo "Dossier servlet non trouvé"
