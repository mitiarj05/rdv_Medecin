    ...
    <div class="card" style="max-width:560px; margin:0 auto;">
        ...
        <form action="${pageContext.request.contextPath}/admin" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nommed" value="${medecin.nommed}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="taux_horaire" value="${medecin.tauxHoraire}" required>
            </div>

            <div class="form-group">
                <label>Lieu / Cabinet</label>
                <input type="text" name="lieu" value="${medecin.lieu}" required>
            </div>
